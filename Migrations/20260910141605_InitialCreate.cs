        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MatchTime = table.Column<TimeOnly>(type: "time", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssistedByPlayerId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MatchEvents_Players_AssistedByPlayerId",
                        column: x => x.AssistedByPlayerId,
                        principalTable: "Players",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_MatchEvents_Players_GoalScorerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MatchEvents_AssistedByPlayerId",
                table: "MatchEvents",
                column: "AssistedByPlayerId");

            migrationBuilder.CreateIndex(
                name: "IX_MatchEvents_GoalScorerId",
                table: "MatchEvents",
                column: "GoalScorerId");
